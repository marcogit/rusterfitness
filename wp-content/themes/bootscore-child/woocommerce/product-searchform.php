...
<form role="search" method="get" class="searchform woocommerce-product-search" action="<?php echo esc_url(home_url('/')); ?>">
  <div class="input-group">
    ...
    <button type="submit" value="<?php echo esc_attr_x( 'Search', 'submit button', 'woocommerce' ); ?>" class="input-group-text btn btn-icon <?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ); ?>"><i class="fa-solid fa-magnifying-glass"></i><span class="visually-hidden-focusable">Search</span></button>
  </div>
</form>